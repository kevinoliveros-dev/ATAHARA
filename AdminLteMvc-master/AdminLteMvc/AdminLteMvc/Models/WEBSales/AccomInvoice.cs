...
namespace AdminLteMvc.Models.WEBSales
{
    public class AccomInvoice
    {
        ...
        public virtual List<AccomInvoiceLines> Lines { get; set; }
        public virtual List<AccomInvoiceSN> SN { get; set; }
        public virtual List<AccomInvoiceWTax> WTax { get; set; }
        public virtual List<AccomInvoiceInst> Inst { get; set; }
    }
}